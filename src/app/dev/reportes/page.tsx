        ...
        <div className="p-8 max-w-5xl mx-auto space-y-8">
            <header>
                <h1 className="text-3xl font-extrabold tracking-tight text-slate-900 flex items-center gap-3">
                    <FileBarChart className="w-8 h-8 text-indigo-600" /> Reportes Post-Mortem
                </h1>
                <p className="text-slate-500 mt-1">Selecciona un proyecto para generar su análisis ejecutivo de métricas y lecciones aprendidas.</p>
            </header>
            ...
            {projects.length === 0 ? (
                <div className="border-2 border-dashed border-slate-200 rounded-xl p-16 text-center">
                    ...
                    <h3 className="text-lg font-bold text-slate-800">Sin Proyectos</h3>
                    <p className="text-slate-500 mt-1">Cuando se creen proyectos desde Oportunidades ganadas, aparecerán aquí para análisis.</p>
                </div>
            ) : (
                <div className="space-y-3">
                    {projects.map(project => (
                        <Link
                            ...
                            className="bg-white border border-slate-200 rounded-xl p-5 flex items-center gap-4 hover:border-indigo-300 hover:shadow-md transition-all group block"
                        >
