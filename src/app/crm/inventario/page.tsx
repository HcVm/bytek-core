    ...
    return (
        <div className="p-8 h-full flex flex-col">
            <div className="flex justify-between items-center mb-8">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-zinc-900">Almacén Central</h1>
                    <p className="text-zinc-500 mt-2">Control de existencia física de hardware y alerta de reposición.</p>
                </div>
                <HardwareFormDialog />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-zinc-500 mt-1">Unidades físicas listas para despliegue</p>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-zinc-500 mt-1">Modelos que requieren compra</p>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-3xl font-bold text-zinc-900">S/ {inventoryValue.toLocaleString('es-PE', { minimumFractionDigits: 2 })}</div>
                        <p className="text-xs text-zinc-500 mt-1">Capital inmovilizado actual</p>
                    </CardContent>
                </Card>
            </div>
            ...
            <Card className="flex-1 flex flex-col">
                <CardHeader>
                    <CardTitle>Catálogo de Hardware Físico</CardTitle>
                    <CardDescription>
                ...
                <CardContent className="flex-1 overflow-auto">
                    {hardware.length > 0 ? (
                            ...
                            <table className="w-full text-sm text-left">
                                ...
                                <tbody>
                                    {hardware.map((item: any) => (
                                        <tr key={item._id} className="border-b last:border-0 hover:bg-zinc-50 transition-colors">
                        ...
                        <div className="flex flex-col items-center justify-center p-12 border-2 border-dashed rounded-xl bg-zinc-50">
                            ...
                            <h3 className="text-lg font-medium text-zinc-900">Sin hardware en el sistema</h3>
