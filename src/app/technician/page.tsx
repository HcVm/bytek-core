...
export default function TechnicianHome() {
    ...
    return (
        <div className="p-4 space-y-6">
            <div>
                <h1 className="text-2xl font-bold text-zinc-900 tracking-tight">Mi Ruta de Hoy</h1>
                <p className="text-zinc-500 text-sm mt-1">Control de visitas, instalaciones y mantenimientos.</p>
            </div>
            ...
            <div className="space-y-4">
                ...
                {activeInterventions.length > 0 ? (
                    ...
                    <div className="p-6 bg-zinc-50 border-2 border-dashed border-zinc-200 rounded-xl text-center">
                        <Wrench className="w-8 h-8 text-zinc-300 mx-auto mb-2" />
                        <p className="text-sm text-zinc-500">No hay intervenciones programadas por el momento.</p>
                    </div>
                )}
            </div>
