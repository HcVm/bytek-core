    ...
    return (
        <div className="min-h-screen bg-zinc-50 flex justify-center">
            ...
            <div className="w-full max-w-md bg-white min-h-screen shadow-2xl overflow-hidden flex flex-col relative">
                <header className="bg-zinc-900 text-white p-4 sticky top-0 z-10 flex justify-between items-center shadow-md">
                    <div className="flex flex-col">
                        <span className="font-bold text-lg leading-none tracking-tight">BYTEK Infra</span>
                        <span className="text-zinc-400 text-xs">Field Service App</span>
                    </div>
